...
public class MaxSliceCalculator {
    ...
    public void printMaxPossibleSliceArea(int radius, int numberOfPeople, int angleDegree, int angleMinutes, int angleSeconds) {
        double biggestSliceArea = getMaxPossibleSliceArea(radius, numberOfPeople, angleDegree, angleMinutes, angleSeconds);
        System.out.printf("%.6f%n", biggestSliceArea);
    }

    public double getMaxPossibleSliceArea(int radius, int numberOfPeople, int angleDegree, int angleMinutes, int angleSeconds) {
        ...
        return ((double) angleForBiggestSlice / completeCircle) * Math.PI * radius * radius;
